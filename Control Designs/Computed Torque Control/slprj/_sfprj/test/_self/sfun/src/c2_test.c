...
static void c2_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_b_qd, const char_T *c2_identifier, real_T c2_y[4]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static creal_T c2_d_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static real_T c2_power(SFc2_testInstanceStruct *chartInstance, real_T c2_a);
...
static void sf_gateway_c2_test(SFc2_testInstanceStruct *chartInstance)
{
  ...
  static creal_T c2_dc0 = { 6.9159003872292E-5, 7.9309688658549236E-5 };

  static creal_T c2_dc1 = { 0.0, 1.1859938250603021E-5 };

  static creal_T c2_dc2 = { 1.011766780992858E-5, 0.0 };
  ...
  c2_t2 = c2_power(chartInstance, c2_c_t);
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 9);
  c2_t3 = c2_power(chartInstance, c2_t2);
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 10);
  c2_t4.re = c2_t3 * c2_dc0.re;
  c2_t4.im = c2_t3 * c2_dc0.im;
  _SFD_SCRIPT_CALL(0U, chartInstance->c2_sfEvent, 11);
  c2_t5.re = (c2_t4.re + c2_dc2.re) + c2_dc1.re;
  c2_t5.im = (c2_t4.im + c2_dc2.im) + c2_dc1.im;
  ...
  c2_b_qd[0] = c2_c_t * 1.011766780992858E-5 + c2_c_t * c2_t3 *
    1.38318007744584E-5;
  c2_b_qd[1] = c2_c_t * 1.1859938250603021E-5 + c2_c_t * c2_t3 *
    1.5861937731709851E-5;
  c2_b_qd[2] = c2_t6;
  ...
  for (c2_i3 = 0; c2_i3 < 4; c2_i3++) {
    (*chartInstance->c2_qd)[c2_i3] = c2_b_qd[c2_i3];
  }
  ...
  for (c2_i4 = 0; c2_i4 < 4; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_qd)[c2_i4], 1U);
  }
}
  ...
  c2_chartNumber, uint32_T c2_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c2_chartNumber, c2_instanceNumber, 0U,
    ...
    "D:\\Multi_robots_control\\4. Computed Torque Control\\TwoRobot_Feedback\\lyacct\\q_desired.m"));
}
  ...
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  creal_T c2_dc3;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), &c2_dc3, 1, 0, 1U, 0, 0U, 0);
  c2_y = c2_dc3;
  sf_mex_destroy(&c2_u);
  return c2_y;
}
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]D:/Multi_robots_control/4. Computed Torque Control/TwoRobot_Feedback/lyacct/q_desired.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1445574450U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  const mxArray *c2_b_is_active_c2_test, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_test),
    &c2_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(244122528U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(44073191U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1294701391U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2281648906U);
}
...
mxArray *sf_c2_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0KcEh7HNN3ZxPFcKkBpYp");
...
static const mxArray *sf_get_sim_state_info_c2_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"qd\",},{M[8],M[0],T\"is_active_c2_test\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_SCRIPT_FCN(0,0,"q_desired",0,-1,461);
...
static void mdlSetWorkWidths_c2_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(983670581U));
  ssSetChecksum1(S,(1736445257U));
  ssSetChecksum2(S,(3504733613U));
  ssSetChecksum3(S,(2584491092U));
