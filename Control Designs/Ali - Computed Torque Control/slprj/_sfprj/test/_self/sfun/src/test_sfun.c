  ...
  const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "btU86XKsFVxXJXTtn9OfKD") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "JjoRPfNE0rpLWIkFRuiCZC") == 0) {
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "JjoRPfNE0rpLWIkFRuiCZC") == 0) {
          extern mxArray *sf_c2_test_jit_fallback_info(void);
          plhs[0] = sf_c2_test_jit_fallback_info();
          break;
        }
      }
  ...
  mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   ...
   case 2:
    {
      if (strcmp(tpChksum, "JjoRPfNE0rpLWIkFRuiCZC") == 0) {
        extern mxArray *sf_c2_test_get_post_codegen_info(void);
        plhs[0] = sf_c2_test_get_post_codegen_info();
        return;
      }
    }
    break;
