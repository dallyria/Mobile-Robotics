...
ac=PossibAc(randi([1,64])); %Next action is chosen randomly.

% ac=AcCh(Qr,st); % Next action is chosen based on its own reward.
...
save ConLeRes Qr st nn Actions TotEval