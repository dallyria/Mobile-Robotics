...
static void c1_emlrt_marshallIn(SFc1_testInstanceStruct *chartInstance, const
  mxArray *c1_b_Tau, const char_T *c1_identifier, real_T c1_y[4]);
...
static real_T c1_power(SFc1_testInstanceStruct *chartInstance, real_T c1_a);
static void c1_eml_scalar_eg(SFc1_testInstanceStruct *chartInstance);
static real_T c1_rdivide(SFc1_testInstanceStruct *chartInstance, real_T c1_x,
  real_T c1_y);
...
static void c1_chartstep_c1_test(SFc1_testInstanceStruct *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c1_d0, 0.01, -1, 2U,
    ...
    if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c1_theta_dot2, 0.0, -1,
          5U, c1_theta_dot2 >= 0.0))) {
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 18);
      c1_theta_2 = c1_theta_1 + 0.01;
    } else {
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[E]D:/Multi_robots_control/4. Computed Torque Control/TwoRobot_Feedback/lyacct/Tau_computed.m"),
                  "context", "context", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("power"), "name", "name", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3387836258U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(71421544U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2421764706U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(205972743U);
}
...
mxArray *sf_c1_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iXoCUCWCdn5v10UYXcgv7C");
...
static const mxArray *sf_get_sim_state_info_c1_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Tau\",},{M[8],M[0],T\"is_active_c1_test\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,506);
        _SFD_CV_INIT_EML_IF(0,1,0,230,258,-1,354);
        _SFD_CV_INIT_EML_IF(0,1,1,263,279,311,350);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,233,258,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,266,279,-1,5);
...
static void mdlSetWorkWidths_c1_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1619187106U));
  ssSetChecksum1(S,(3027144676U));
  ssSetChecksum2(S,(3399967747U));
  ssSetChecksum3(S,(2176744796U));
