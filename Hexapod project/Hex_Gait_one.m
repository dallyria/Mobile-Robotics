...
Ltip=Q2;
% 
%     Q2(1:3,1)=Q2(1:3,1)+[0;Vy*delta_t;0];
%     Q2(1:3,3)=Q2(1:3,3)+[0;Vy*delta_t;0];
%     Q2(1:3,5)=Q2(1:3,5)+[0;Vy*delta_t;0];
while k<=steps+1
%% Configuration =========================================================
...
if k<(steps+1)/2
    ...
    OPPx=0;
    OPPz=7;
    Ltip(1:3,1)=Q2(1:3,1)+[0;2*Vy*q*delta_t/stp;3*sin(pi*q/stp)];
    Ltip(1:3,3)=Q2(1:3,3)+[0;2*Vy*q*delta_t/stp;3*sin(pi*q/stp)];
    Ltip(1:3,5)=Q2(1:3,5)+[0;2*Vy*q*delta_t/stp;3*sin(pi*q/stp)];
elseif k<=steps+1 && k>=(steps+1)/2
    stp=steps/2;
    OPPy=Vy*2*q*delta_t/steps;
    OPPx=0;
    OPPz=7;
    q1=k-(steps+1)/2-1;
    Ltip(1:3,2)=Q2(1:3,2)+[0;2*Vy*q1*delta_t/stp;3*sin(pi*q1/stp)];
    Ltip(1:3,4)=Q2(1:3,4)+[0;2*Vy*q1*delta_t/stp;3*sin(pi*q1/stp)];
    Ltip(1:3,6)=Q2(1:3,6)+[0;2*Vy*q1*delta_t/stp;3*sin(pi*q1/stp)];
