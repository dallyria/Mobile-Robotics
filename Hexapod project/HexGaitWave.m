...
if mod(Nstep,6)==0
    ...
    Ltip(1:3,4)=LQ(1:3,4)+DeltaLtip;%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,6)=LQ(1:3,6);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
elseif mod(Nstep,6)==5

    Ltip(1:3,1)=LQ(1:3,1);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,3)=LQ(1:3,3);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,5)=LQ(1:3,5)+DeltaLtip;%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,2)=LQ(1:3,2);
    Ltip(1:3,4)=LQ(1:3,4);
    Ltip(1:3,6)=LQ(1:3,6);
elseif mod(Nstep,6)==4
...
elseif mod(Nstep,6)==3

    Ltip(1:3,1)=LQ(1:3,1);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,3)=LQ(1:3,3)+DeltaLtip;%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,5)=LQ(1:3,5);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,2)=LQ(1:3,2);
    Ltip(1:3,4)=LQ(1:3,4);
    Ltip(1:3,6)=LQ(1:3,6);
elseif mod(Nstep,6)==2
    ...
    Ltip(1:3,4)=LQ(1:3,4);
    Ltip(1:3,6)=LQ(1:3,6);
elseif mod(Nstep,6)==1

    Ltip(1:3,1)=LQ(1:3,1)+DeltaLtip;%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,3)=LQ(1:3,3);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,5)=LQ(1:3,5);%+[2*Vx*time;2*Vy*time;3*sin(w*time)];
    Ltip(1:3,2)=LQ(1:3,2);
    Ltip(1:3,4)=LQ(1:3,4);
